...
const Mainpage = () => {
        ...
        const fetchUserProfile = async () => {
            try {
                ...
                if (result.success && result.data) {
                    // username 또는 name 선택 가능
                    setUsername(result.data.name || result.data.username);
                }
            } catch (error) {
    ...
    const places = [
        { id: 1, title: "안양시 만안구 성결대학교 44", address: "내 집 앞 쓰레기...", imageUrl: "sample/tresh-1.jpg", point: 300, distance: 8 },
        { id: 2, title: "경기도 안양시 동안구 관양동 53", address: "골목가 쓰레기 더미", imageUrl: "sample/tresh-1.jpg", point: 300, distance: 25 },
        { id: 3, title: "경기도 안양시 만안구 성결…", address: "계단 앞 무단투기", imageUrl: "sample/tresh-1.jpg", point: 300, distance: 5 },
    ];
        ...
        <div>
            <div className="bg-white min-h-screen text-[#73C03F]">
                ...
                <div className="relative">
                    <img src="image-2.png" alt="hero" className="w-full object-cover"/>
                    ...
                    <div className="absolute -bottom-70 w-full flex justify-center">
                        <div className="bg-white rounded-t-3xl p-6 w-full max-w-lg">
                            ...
                            <div className="flex space-x-4 overflow-x-auto pb-4">
                                {places.map((place) => (
                                    <div key={place.id} className="bg-white rounded-2xl shadow-md w-50 flex-shrink-0 flex flex-col">
                                        <img
                                            src={place.imageUrl}
                                            alt={place.title}
                                        ...
                                        <div className="p-3 flex-1">
                                            ...
                                            <p className="text-xs font-bold mt-1">{place.distance}m 거리</p>
                                        </div>
